...
source=("http://repository.spotify.com/pool/non-free/s/spotify-client/spotify-client_${pkgver}${_anotherpkgver}-30_amd64.deb"
        "spotify"
        "spotify.protocol")
md5sums=('0ed02db6c7c35a83ac73055865b4b350'
